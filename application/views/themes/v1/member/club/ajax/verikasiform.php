<?php foreach ($verify as $ver): ?>
	...
	<div class="x-form-daftar-pemain row">
		...
		<a href="javascript:void(0)" title="Setujui" id="approve_<?php echo $ver->id; ?>" class="form_post" action="member" fn="verifyapp" onclick="return confirm('Apakah anda yakin menerima pendaftar ini?')">
